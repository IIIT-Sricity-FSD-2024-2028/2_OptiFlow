...
(function (global) {
      ...
      const evidence = [
        {
          ...
          notes:
            "Packet verified and signed by TL; ready for Compliance review.",
        ...
        },
        {
          ...
          notes:
            "Attached reconciliation summary; pending final variance review.",
  ...
  global.initializePMDatabase =
    global.initializePMDatabase || initializePMDatabase;
