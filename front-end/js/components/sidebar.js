  ...
  navConfig: {
    ...
    Project_Manager: [
      ...
      },
      {
        ...
        label: "Compliance",
        icon: "shield",
        href: "admin/pm/compliance-dashboard.html",
        badge: "violations",
        absolute: true,
      },
    ],
    Team_Leader: [
      {
        ...
        label: "Dashboard",
        icon: "grid",
        href: "enduser/tl-dashboard.html",
        absolute: true,
      },
      { id: "tasks", label: "My Tasks", icon: "tasks", href: "enduser/my-tasks.html", absolute: true },
      { id: "evidence", label: "Evidence", icon: "doc", href: "enduser/evidence.html", absolute: true },
    ],
    Team_Member: [
      {
        id: "dashboard",
        label: "Dashboard",
        icon: "grid",
        href: "enduser/member-dashboard.html",
        absolute: true,
      },
      { id: "tasks", label: "My Tasks", icon: "tasks", href: "enduser/my-tasks.html", absolute: true },
      { id: "evidence", label: "Evidence", icon: "doc", href: "enduser/evidence.html", absolute: true },
