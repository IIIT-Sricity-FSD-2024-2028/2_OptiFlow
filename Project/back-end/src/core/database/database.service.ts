...
export class DatabaseService {
  ...
  // 13. Tasks
  public tasks: Task[] = [
    { task_id: 101, project_id: 1, workflow_instance_id: null, title: 'Reconcile vendor invoices', description: 'Cross-check invoices.', created_by: 4, assigned_to: 5, status: 'In_Progress', priority: 'High', estimated_hours: 8, actual_hours: 3, start_date: '2024-11-10', due_date: '2024-11-20', completed_at: null, created_at: '2024-10-05T09:00:00Z', updated_at: '2024-10-05T09:00:00Z', deleted_at: null },
    { task_id: 102, project_id: 1, workflow_instance_id: 3, title: 'Review SOX Controls', description: 'Validate controls (budget approved).', created_by: 6, assigned_to: 4, status: 'In_Review', priority: 'Critical', estimated_hours: 16, actual_hours: 16, start_date: '2024-11-01', due_date: '2024-11-15', completed_at: null, created_at: '2024-10-06T09:00:00Z', updated_at: '2024-10-06T09:00:00Z', deleted_at: null },
    { task_id: 103, project_id: 2, workflow_instance_id: null, title: 'Patch server vulnerabilities', description: 'Apply OS patches.', created_by: 8, assigned_to: 9, status: 'Blocked', priority: 'Critical', estimated_hours: 12, actual_hours: 2, start_date: '2024-11-15', due_date: '2024-11-30', completed_at: null, created_at: '2024-09-15T09:00:00Z', updated_at: '2024-11-18T10:00:00Z', deleted_at: null },
    { task_id: 104, project_id: 2, workflow_instance_id: null, title: 'Firewall rules audit', description: 'Review stale FW rules.', created_by: 8, assigned_to: 9, status: 'Pending', priority: 'High', estimated_hours: 6, actual_hours: 0, start_date: null, due_date: '2024-12-05', completed_at: null, created_at: '2024-09-16T09:00:00Z', updated_at: '2024-09-16T09:00:00Z', deleted_at: null },
    ...
    { task_id: 106, project_id: 6, workflow_instance_id: null, title: 'Setup Docker Swarm cluster', description: 'Initialize the new swarm.', created_by: 10, assigned_to: 10, status: 'In_Progress', priority: 'Medium', estimated_hours: 10, actual_hours: 4, start_date: '2024-11-05', due_date: '2024-11-25', completed_at: null, created_at: '2024-11-01T10:00:00Z', updated_at: '2024-11-05T10:00:00Z', deleted_at: null },
